...
export function buildGeniusQuestions(people: GeniusPerson[] = []): GeniusQuestion[] {
  ...
  const questions: GeniusQuestion[] = [
    ...
    booleanQuestion("champion", "你想的这位人物作为首发选手或教练，拿过 KPL 联赛或冠军杯系列赛事冠军吗？", "生涯荣誉", (person) => person.championshipCount === null ? null : person.championshipCount > 0),
    booleanQuestion("champion:3", "你想的这位人物作为首发选手或教练，至少拿过三次 KPL 联赛或冠军杯系列赛事冠军吗？", "生涯荣誉", (person) => person.championshipCount === null ? null : person.championshipCount >= 3),
    booleanQuestion("champion:5", "你想的这位人物作为首发选手或教练，至少拿过五次 KPL 联赛或冠军杯系列赛事冠军吗？", "生涯荣誉", (person) => person.championshipCount === null ? null : person.championshipCount >= 5),
